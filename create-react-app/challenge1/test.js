...
test("bottom function should return bottom 2 numbers over average for [1,2,4,5]", t => {
  t.deepEqual(bottom([1, 2, 4, 5]), [1, 2])
})

test("bottom function should return bottom 2 numbers over average for [1,2,3,4,5]", t => {
